...
import com.example.memoire.SingleExpansionListActivity;
...
public class SingleExpansionListActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_singleexpansionlist);
		...
		public void onClick(View v) {
			...
			for(int i=0;i<array_master.length;i++){
				if(text.equals(array_master[i])){
					...
					listTextView[i].setVisibility(View.GONE);
				}
			}
		}
	};
