...
import com.example.memoire.BulletedListActivity;
...
public class BulletedListActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_bulletedlist);
	    ...
	    for(int i = 0 ; i < array_master.length ; i++) {
	    	...
	    	item.put("masterItem", Html.fromHtml("&#8226; " + array_master[i]).toString());
	    	list.add(item);
	    }
